...
public class CarService {
    ...
    public Car findById(Long id) throws CarNotFoundException {
        ...
        // Note: price is annotated @Transient, hence pricing service needs to be called each time
        car.setPrice(priceClient.getPrice(id));

        // Note: address is annotated @Transient, hence maps service needs to be called each time
